...
- run `VehicleCounterOpenCV.ipynb` for real time data extraction. accuracy around 85% , frame processing time is less than 0.03 seconds. 
 <img style="float: center;" src="/images/cv1.png" width="140" height="120" />
 <img style="float: center;" src="/images/cv2.png" width="140" height="120" />
 <img style="float: center;" src="/images/cv3.png" width="140" height="120" />
 <img style="float: center;" src="/images/cv.png" width="140" height="120" />
